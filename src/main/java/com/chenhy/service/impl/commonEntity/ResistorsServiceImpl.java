...
@Service
@Transactional
public class ResistorsServiceImpl implements ResistorsService {

    private static final Logger LOG = LoggerFactory.getLogger(ResistorsServiceImpl.class);

    private final ResistorsRepository ResistorsRepository;

    public ResistorsServiceImpl(ResistorsRepository ResistorsRepository) {
