...
@Service
@Transactional
public class MicrophonesServiceImpl implements ResistorsService {

    private static final Logger LOG = LoggerFactory.getLogger(MicrophonesServiceImpl.class);

    private final ResistorsRepository ResistorsRepository;

    public MicrophonesServiceImpl(ResistorsRepository ResistorsRepository) {
