...
@Service
@Transactional
public class TransistorsServiceImpl implements ResistorsService {

    private static final Logger LOG = LoggerFactory.getLogger(TransistorsServiceImpl.class);

    private final ResistorsRepository ResistorsRepository;

    public TransistorsServiceImpl(ResistorsRepository ResistorsRepository) {
