...
/**
 * A LiquidCrystalDisplay.
 */
@Entity
@Table(name = "liquid_crystal_display")
@SuppressWarnings("common-java:DuplicatedBlocks")
public class LiquidCrystalDisplay implements Serializable {
    ...
    public LiquidCrystalDisplay id(String id) {
        this.setId(id);
        return this;
    }
    ...
    // 删除原有的 uuid 相关方法
    // public UUID getUuid() { ... }
    // public LiquidCrystalDisplay uuid(UUID uuid) { ... }
    // public void setUuid(UUID uuid) { ... }
    public String getPartNumber() {
        return this.partNumber;
    }

    public LiquidCrystalDisplay partNumber(String partNumber) {
    ...
    public LiquidCrystalDisplay partType(String partType) {
    ...
    public LiquidCrystalDisplay value(String value) {
        this.setValue(value);
        return this;
    }
    ...
    public LiquidCrystalDisplay schematicPart(String schematicPart) {
    ...
    public LiquidCrystalDisplay ratingVoltage(String ratingVoltage) {
    ...
    public LiquidCrystalDisplay ratingElectricity(String ratingElectricity) {
    ...
    public LiquidCrystalDisplay characteristics(String characteristics) {
    ...
    public LiquidCrystalDisplay tolerance(String tolerance) {
    ...
    public LiquidCrystalDisplay manufacture(String manufacture) {
    ...
    public LiquidCrystalDisplay bCode(String bCode) {
        this.setbCode(bCode);
        return this;
    }
    ...
    public LiquidCrystalDisplay partsName(String partsName) {
    ...
    public LiquidCrystalDisplay itemRegistrationClassification(String itemRegistrationClassification) {
    ...
    public LiquidCrystalDisplay spiceModel(String spiceModel) {
    ...
    public LiquidCrystalDisplay pcbFootPrint(String pcbFootPrint) {
    ...
    public LiquidCrystalDisplay delFlag(Boolean delFlag) {
    ...
    public LiquidCrystalDisplay remark(String remark) {
    ...
    public LiquidCrystalDisplay createBy(String createBy) {
    ...
    public LiquidCrystalDisplay createTime(Instant createTime) {
    ...
    public LiquidCrystalDisplay updateBy(String updateBy) {
    ...
    public LiquidCrystalDisplay updateTime(Instant updateTime) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LiquidCrystalDisplay)) {
            return false;
        }
        return getId() != null && getId().equals(((LiquidCrystalDisplay) o).getId());
    }
