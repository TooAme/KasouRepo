...
public class Antennas implements Serializable {
    ...
    // 删除原有的 uuid 相关方法
    // public UUID getUuid() { ... }
    // public Antennas uuid(UUID uuid) { ... }
    // public void setUuid(UUID uuid) { ... }
    public String getPartNumber() {
        return this.partNumber;
    }

    public Antennas partNumber(String partNumber) {
    ...
    public Antennas partType(String partType) {
    ...
    public Antennas value(String value) {
        this.setValue(value);
        return this;
    }
    ...
    public Antennas schematicPart(String schematicPart) {
    ...
    public Antennas ratingVoltage(String ratingVoltage) {
    ...
    public Antennas ratingElectricity(String ratingElectricity) {
    ...
    public Antennas characteristics(String characteristics) {
    ...
    public Antennas tolerance(String tolerance) {
    ...
    public Antennas manufacture(String manufacture) {
    ...
    public Antennas bCode(String bCode) {
        this.setbCode(bCode);
        return this;
    }
    ...
    public Antennas partsName(String partsName) {
    ...
    public Antennas itemRegistrationClassification(String itemRegistrationClassification) {
    ...
    public Antennas spiceModel(String spiceModel) {
    ...
    public Antennas pcbFootPrint(String pcbFootPrint) {
    ...
    public Antennas delFlag(Boolean delFlag) {
    ...
    public Antennas remark(String remark) {
    ...
    public Antennas createBy(String createBy) {
    ...
    public Antennas createTime(Instant createTime) {
    ...
    public Antennas updateBy(String updateBy) {
    ...
    public Antennas updateTime(Instant updateTime) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Antennas)) {
            return false;
        }
        return getId() != null && getId().equals(((Antennas) o).getId());
    }
