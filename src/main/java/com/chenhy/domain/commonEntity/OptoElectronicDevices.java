...
/**
 * A OptoElectronicDevices.
 */
@Entity
@Table(name = "opto_electronic_devices")
@SuppressWarnings("common-java:DuplicatedBlocks")
public class OptoElectronicDevices implements Serializable {
    ...
    public OptoElectronicDevices id(String id) {
        this.setId(id);
        return this;
    }
    ...
    // 删除原有的 uuid 相关方法
    // public UUID getUuid() { ... }
    // public OptoElectronicDevices uuid(UUID uuid) { ... }
    // public void setUuid(UUID uuid) { ... }
    public String getPartNumber() {
        return this.partNumber;
    }

    public OptoElectronicDevices partNumber(String partNumber) {
    ...
    public OptoElectronicDevices partType(String partType) {
    ...
    public OptoElectronicDevices value(String value) {
        this.setValue(value);
        return this;
    }
    ...
    public OptoElectronicDevices schematicPart(String schematicPart) {
    ...
    public OptoElectronicDevices ratingVoltage(String ratingVoltage) {
    ...
    public OptoElectronicDevices ratingElectricity(String ratingElectricity) {
    ...
    public OptoElectronicDevices characteristics(String characteristics) {
    ...
    public OptoElectronicDevices tolerance(String tolerance) {
    ...
    public OptoElectronicDevices manufacture(String manufacture) {
    ...
    public OptoElectronicDevices bCode(String bCode) {
        this.setbCode(bCode);
        return this;
    }
    ...
    public OptoElectronicDevices partsName(String partsName) {
    ...
    public OptoElectronicDevices itemRegistrationClassification(String itemRegistrationClassification) {
    ...
    public OptoElectronicDevices spiceModel(String spiceModel) {
    ...
    public OptoElectronicDevices pcbFootPrint(String pcbFootPrint) {
    ...
    public OptoElectronicDevices delFlag(Boolean delFlag) {
    ...
    public OptoElectronicDevices remark(String remark) {
    ...
    public OptoElectronicDevices createBy(String createBy) {
    ...
    public OptoElectronicDevices createTime(Instant createTime) {
    ...
    public OptoElectronicDevices updateBy(String updateBy) {
    ...
    public OptoElectronicDevices updateTime(Instant updateTime) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OptoElectronicDevices)) {
            return false;
        }
        return getId() != null && getId().equals(((OptoElectronicDevices) o).getId());
    }
