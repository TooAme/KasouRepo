...
public class Sockets implements Serializable {
    ...
    // 删除原有的 uuid 相关方法
    // public UUID getUuid() { ... }
    // public Sockets uuid(UUID uuid) { ... }
    // public void setUuid(UUID uuid) { ... }
    public String getPartNumber() {
        return this.partNumber;
    }

    public Sockets partNumber(String partNumber) {
    ...
    public Sockets partType(String partType) {
    ...
    public Sockets value(String value) {
        this.setValue(value);
        return this;
    }
    ...
    public Sockets schematicPart(String schematicPart) {
    ...
    public Sockets ratingVoltage(String ratingVoltage) {
    ...
    public Sockets ratingElectricity(String ratingElectricity) {
    ...
    public Sockets characteristics(String characteristics) {
    ...
    public Sockets tolerance(String tolerance) {
    ...
    public Sockets manufacture(String manufacture) {
    ...
    public Sockets bCode(String bCode) {
        this.setbCode(bCode);
        return this;
    }
    ...
    public Sockets partsName(String partsName) {
    ...
    public Sockets itemRegistrationClassification(String itemRegistrationClassification) {
    ...
    public Sockets spiceModel(String spiceModel) {
    ...
    public Sockets pcbFootPrint(String pcbFootPrint) {
    ...
    public Sockets delFlag(Boolean delFlag) {
    ...
    public Sockets remark(String remark) {
    ...
    public Sockets createBy(String createBy) {
    ...
    public Sockets createTime(Instant createTime) {
    ...
    public Sockets updateBy(String updateBy) {
    ...
    public Sockets updateTime(Instant updateTime) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Sockets)) {
            return false;
        }
        return getId() != null && getId().equals(((Sockets) o).getId());
    }
