 ...
 */
@Entity
@Table(name = "varistors")
@SuppressWarnings("common-java:DuplicatedBlocks")
public class Varistors implements Serializable {
    ...
    // 删除原有的 uuid 相关方法
    // public UUID getUuid() { ... }
    // public Varistors uuid(UUID uuid) { ... }
    // public void setUuid(UUID uuid) { ... }
    public String getPartNumber() {
        return this.partNumber;
    }

    public Varistors partNumber(String partNumber) {
    ...
    public Varistors partType(String partType) {
    ...
    public Varistors value(String value) {
        this.setValue(value);
        return this;
    }
    ...
    public Varistors schematicPart(String schematicPart) {
    ...
    public Varistors ratingVoltage(String ratingVoltage) {
    ...
    public Varistors ratingElectricity(String ratingElectricity) {
    ...
    public Varistors characteristics(String characteristics) {
    ...
    public Varistors tolerance(String tolerance) {
    ...
    public Varistors manufacture(String manufacture) {
    ...
    public Varistors bCode(String bCode) {
        this.setbCode(bCode);
        return this;
    }
    ...
    public Varistors partsName(String partsName) {
    ...
    public Varistors itemRegistrationClassification(String itemRegistrationClassification) {
    ...
    public Varistors spiceModel(String spiceModel) {
    ...
    public Varistors pcbFootPrint(String pcbFootPrint) {
    ...
    public Varistors delFlag(Boolean delFlag) {
    ...
    public Varistors remark(String remark) {
    ...
    public Varistors createBy(String createBy) {
    ...
    public Varistors createTime(Instant createTime) {
    ...
    public Varistors updateBy(String updateBy) {
    ...
    public Varistors updateTime(Instant updateTime) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Varistors)) {
            return false;
        }
        return getId() != null && getId().equals(((Varistors) o).getId());
    }
