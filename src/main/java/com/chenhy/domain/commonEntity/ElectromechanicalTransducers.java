...
/**
 * A ElectromechanicalTransducers.
 */
@Entity
@Table(name = "electromechanical_transducers")
@SuppressWarnings("common-java:DuplicatedBlocks")
public class ElectromechanicalTransducers implements Serializable {
    ...
    public ElectromechanicalTransducers id(String id) {
        this.setId(id);
        return this;
    }
    ...
    // 删除原有的 uuid 相关方法
    // public UUID getUuid() { ... }
    // public ElectromechanicalTransducers uuid(UUID uuid) { ... }
    // public void setUuid(UUID uuid) { ... }
    public String getPartNumber() {
        return this.partNumber;
    }

    public ElectromechanicalTransducers partNumber(String partNumber) {
    ...
    public ElectromechanicalTransducers partType(String partType) {
    ...
    public ElectromechanicalTransducers value(String value) {
        this.setValue(value);
        return this;
    }
    ...
    public ElectromechanicalTransducers schematicPart(String schematicPart) {
    ...
    public ElectromechanicalTransducers ratingVoltage(String ratingVoltage) {
    ...
    public ElectromechanicalTransducers ratingElectricity(String ratingElectricity) {
    ...
    public ElectromechanicalTransducers characteristics(String characteristics) {
    ...
    public ElectromechanicalTransducers tolerance(String tolerance) {
    ...
    public ElectromechanicalTransducers manufacture(String manufacture) {
    ...
    public ElectromechanicalTransducers bCode(String bCode) {
        this.setbCode(bCode);
        return this;
    }
    ...
    public ElectromechanicalTransducers partsName(String partsName) {
    ...
    public ElectromechanicalTransducers itemRegistrationClassification(String itemRegistrationClassification) {
    ...
    public ElectromechanicalTransducers spiceModel(String spiceModel) {
    ...
    public ElectromechanicalTransducers pcbFootPrint(String pcbFootPrint) {
    ...
    public ElectromechanicalTransducers delFlag(Boolean delFlag) {
    ...
    public ElectromechanicalTransducers remark(String remark) {
    ...
    public ElectromechanicalTransducers createBy(String createBy) {
    ...
    public ElectromechanicalTransducers createTime(Instant createTime) {
    ...
    public ElectromechanicalTransducers updateBy(String updateBy) {
    ...
    public ElectromechanicalTransducers updateTime(Instant updateTime) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ElectromechanicalTransducers)) {
            return false;
        }
        return getId() != null && getId().equals(((ElectromechanicalTransducers) o).getId());
    }
    ...
    public String toString() {
        return "ElectromechanicalTransducers{" +
            "id=" + getId() +
