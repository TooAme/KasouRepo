...
public class PowerSupplies implements Serializable {
    ...
    public PowerSupplies id(String id) {
        this.setId(id);
        return this;
    }
    ...
    // 删除原有的 uuid 相关方法
    // public UUID getUuid() { ... }
    // public PowerSupplies uuid(UUID uuid) { ... }
    // public void setUuid(UUID uuid) { ... }
    public String getPartNumber() {
        return this.partNumber;
    }

    public PowerSupplies partNumber(String partNumber) {
    ...
    public PowerSupplies partType(String partType) {
    ...
    public PowerSupplies value(String value) {
        this.setValue(value);
        return this;
    }
    ...
    public PowerSupplies schematicPart(String schematicPart) {
    ...
    public PowerSupplies ratingVoltage(String ratingVoltage) {
    ...
    public PowerSupplies ratingElectricity(String ratingElectricity) {
    ...
    public PowerSupplies characteristics(String characteristics) {
    ...
    public PowerSupplies tolerance(String tolerance) {
    ...
    public PowerSupplies manufacture(String manufacture) {
    ...
    public PowerSupplies bCode(String bCode) {
        this.setbCode(bCode);
        return this;
    }
    ...
    public PowerSupplies partsName(String partsName) {
    ...
    public PowerSupplies itemRegistrationClassification(String itemRegistrationClassification) {
    ...
    public PowerSupplies spiceModel(String spiceModel) {
    ...
    public PowerSupplies pcbFootPrint(String pcbFootPrint) {
    ...
    public PowerSupplies delFlag(Boolean delFlag) {
    ...
    public PowerSupplies remark(String remark) {
    ...
    public PowerSupplies createBy(String createBy) {
    ...
    public PowerSupplies createTime(Instant createTime) {
    ...
    public PowerSupplies updateBy(String updateBy) {
    ...
    public PowerSupplies updateTime(Instant updateTime) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PowerSupplies)) {
            return false;
        }
        return getId() != null && getId().equals(((PowerSupplies) o).getId());
    }
