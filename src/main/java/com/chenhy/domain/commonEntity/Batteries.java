...
public class Batteries implements Serializable {
    ...
    // 删除原有的 uuid 相关方法
    // public UUID getUuid() { ... }
    // public Batteries uuid(UUID uuid) { ... }
    // public void setUuid(UUID uuid) { ... }
    public String getPartNumber() {
        return this.partNumber;
    }

    public Batteries partNumber(String partNumber) {
    ...
    public Batteries partType(String partType) {
    ...
    public Batteries value(String value) {
        this.setValue(value);
        return this;
    }
    ...
    public Batteries schematicPart(String schematicPart) {
    ...
    public Batteries ratingVoltage(String ratingVoltage) {
    ...
    public Batteries ratingElectricity(String ratingElectricity) {
    ...
    public Batteries characteristics(String characteristics) {
    ...
    public Batteries tolerance(String tolerance) {
    ...
    public Batteries manufacture(String manufacture) {
    ...
    public Batteries bCode(String bCode) {
        this.setbCode(bCode);
        return this;
    }
    ...
    public Batteries partsName(String partsName) {
    ...
    public Batteries itemRegistrationClassification(String itemRegistrationClassification) {
    ...
    public Batteries spiceModel(String spiceModel) {
    ...
    public Batteries pcbFootPrint(String pcbFootPrint) {
    ...
    public Batteries delFlag(Boolean delFlag) {
    ...
    public Batteries remark(String remark) {
    ...
    public Batteries createBy(String createBy) {
    ...
    public Batteries createTime(Instant createTime) {
    ...
    public Batteries updateBy(String updateBy) {
    ...
    public Batteries updateTime(Instant updateTime) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Batteries)) {
            return false;
        }
        return getId() != null && getId().equals(((Batteries) o).getId());
    }
