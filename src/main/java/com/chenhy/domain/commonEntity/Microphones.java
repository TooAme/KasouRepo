...
public class Microphones implements Serializable {
    ...
    public Microphones id(String id) {
        this.setId(id);
        return this;
    }
    ...
    // 删除原有的 uuid 相关方法
    // public UUID getUuid() { ... }
    // public Microphones uuid(UUID uuid) { ... }
    // public void setUuid(UUID uuid) { ... }
    public String getPartNumber() {
        return this.partNumber;
    }

    public Microphones partNumber(String partNumber) {
    ...
    public Microphones partType(String partType) {
    ...
    public Microphones value(String value) {
        this.setValue(value);
        return this;
    }
    ...
    public Microphones schematicPart(String schematicPart) {
    ...
    public Microphones ratingVoltage(String ratingVoltage) {
    ...
    public Microphones ratingElectricity(String ratingElectricity) {
    ...
    public Microphones characteristics(String characteristics) {
    ...
    public Microphones tolerance(String tolerance) {
    ...
    public Microphones manufacture(String manufacture) {
    ...
    public Microphones bCode(String bCode) {
        this.setbCode(bCode);
        return this;
    }
    ...
    public Microphones partsName(String partsName) {
    ...
    public Microphones itemRegistrationClassification(String itemRegistrationClassification) {
    ...
    public Microphones spiceModel(String spiceModel) {
    ...
    public Microphones pcbFootPrint(String pcbFootPrint) {
    ...
    public Microphones delFlag(Boolean delFlag) {
    ...
    public Microphones remark(String remark) {
    ...
    public Microphones createBy(String createBy) {
    ...
    public Microphones createTime(Instant createTime) {
    ...
    public Microphones updateBy(String updateBy) {
    ...
    public Microphones updateTime(Instant updateTime) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Microphones)) {
            return false;
        }
        return getId() != null && getId().equals(((Microphones) o).getId());
    }
