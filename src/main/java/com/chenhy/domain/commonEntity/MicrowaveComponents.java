...
/**
 * A MicrowaveComponents.
 */
@Entity
@Table(name = "microwave_components")
@SuppressWarnings("common-java:DuplicatedBlocks")
public class MicrowaveComponents implements Serializable {
    ...
    public MicrowaveComponents id(String id) {
        this.setId(id);
        return this;
    }
    ...
    // 删除原有的 uuid 相关方法
    // public UUID getUuid() { ... }
    // public MicrowaveComponents uuid(UUID uuid) { ... }
    // public void setUuid(UUID uuid) { ... }
    public String getPartNumber() {
        return this.partNumber;
    }

    public MicrowaveComponents partNumber(String partNumber) {
    ...
    public MicrowaveComponents partType(String partType) {
    ...
    public MicrowaveComponents value(String value) {
        this.setValue(value);
        return this;
    }
    ...
    public MicrowaveComponents schematicPart(String schematicPart) {
    ...
    public MicrowaveComponents ratingVoltage(String ratingVoltage) {
    ...
    public MicrowaveComponents ratingElectricity(String ratingElectricity) {
    ...
    public MicrowaveComponents characteristics(String characteristics) {
    ...
    public MicrowaveComponents tolerance(String tolerance) {
    ...
    public MicrowaveComponents manufacture(String manufacture) {
    ...
    public MicrowaveComponents bCode(String bCode) {
        this.setbCode(bCode);
        return this;
    }
    ...
    public MicrowaveComponents partsName(String partsName) {
    ...
    public MicrowaveComponents itemRegistrationClassification(String itemRegistrationClassification) {
    ...
    public MicrowaveComponents spiceModel(String spiceModel) {
    ...
    public MicrowaveComponents pcbFootPrint(String pcbFootPrint) {
    ...
    public MicrowaveComponents delFlag(Boolean delFlag) {
    ...
    public MicrowaveComponents remark(String remark) {
    ...
    public MicrowaveComponents createBy(String createBy) {
    ...
    public MicrowaveComponents createTime(Instant createTime) {
    ...
    public MicrowaveComponents updateBy(String updateBy) {
    ...
    public MicrowaveComponents updateTime(Instant updateTime) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MicrowaveComponents)) {
            return false;
        }
        return getId() != null && getId().equals(((MicrowaveComponents) o).getId());
    }
