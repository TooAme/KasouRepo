 ...
 */
@Entity
@Table(name = "thermistors")
@SuppressWarnings("common-java:DuplicatedBlocks")
public class Thermistors implements Serializable {
    ...
    public Thermistors id(String id) {
        this.setId(id);
        return this;
    }
    ...
    // 删除原有的 uuid 相关方法
    // public UUID getUuid() { ... }
    // public Thermistors uuid(UUID uuid) { ... }
    // public void setUuid(UUID uuid) { ... }
    public String getPartNumber() {
        return this.partNumber;
    }

    public Thermistors partNumber(String partNumber) {
    ...
    public Thermistors partType(String partType) {
    ...
    public Thermistors value(String value) {
        this.setValue(value);
        return this;
    }
    ...
    public Thermistors schematicPart(String schematicPart) {
    ...
    public Thermistors ratingVoltage(String ratingVoltage) {
    ...
    public Thermistors ratingElectricity(String ratingElectricity) {
    ...
    public Thermistors characteristics(String characteristics) {
    ...
    public Thermistors tolerance(String tolerance) {
    ...
    public Thermistors manufacture(String manufacture) {
    ...
    public Thermistors bCode(String bCode) {
        this.setbCode(bCode);
        return this;
    }
    ...
    public Thermistors partsName(String partsName) {
    ...
    public Thermistors itemRegistrationClassification(String itemRegistrationClassification) {
    ...
    public Thermistors spiceModel(String spiceModel) {
    ...
    public Thermistors pcbFootPrint(String pcbFootPrint) {
    ...
    public Thermistors delFlag(Boolean delFlag) {
    ...
    public Thermistors remark(String remark) {
    ...
    public Thermistors createBy(String createBy) {
    ...
    public Thermistors createTime(Instant createTime) {
    ...
    public Thermistors updateBy(String updateBy) {
    ...
    public Thermistors updateTime(Instant updateTime) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Thermistors)) {
            return false;
        }
        return getId() != null && getId().equals(((Thermistors) o).getId());
    }
