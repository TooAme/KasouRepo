 ...
 */
@Entity
@Table(name = "rf_components")
@SuppressWarnings("common-java:DuplicatedBlocks")
public class RfComponents implements Serializable {
    ...
    public RfComponents id(String id) {
        this.setId(id);
        return this;
    }
    ...
    // 删除原有的 uuid 相关方法
    // public UUID getUuid() { ... }
    // public RfComponents uuid(UUID uuid) { ... }
    // public void setUuid(UUID uuid) { ... }
    public String getPartNumber() {
        return this.partNumber;
    }

    public RfComponents partNumber(String partNumber) {
    ...
    public RfComponents partType(String partType) {
    ...
    public RfComponents value(String value) {
        this.setValue(value);
        return this;
    }
    ...
    public RfComponents schematicPart(String schematicPart) {
    ...
    public RfComponents ratingVoltage(String ratingVoltage) {
    ...
    public RfComponents ratingElectricity(String ratingElectricity) {
    ...
    public RfComponents characteristics(String characteristics) {
    ...
    public RfComponents tolerance(String tolerance) {
    ...
    public RfComponents manufacture(String manufacture) {
    ...
    public RfComponents bCode(String bCode) {
        this.setbCode(bCode);
        return this;
    }
    ...
    public RfComponents partsName(String partsName) {
    ...
    public RfComponents itemRegistrationClassification(String itemRegistrationClassification) {
    ...
    public RfComponents spiceModel(String spiceModel) {
    ...
    public RfComponents pcbFootPrint(String pcbFootPrint) {
    ...
    public RfComponents delFlag(Boolean delFlag) {
    ...
    public RfComponents remark(String remark) {
    ...
    public RfComponents createBy(String createBy) {
    ...
    public RfComponents createTime(Instant createTime) {
    ...
    public RfComponents updateBy(String updateBy) {
    ...
    public RfComponents updateTime(Instant updateTime) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RfComponents)) {
            return false;
        }
        return getId() != null && getId().equals(((RfComponents) o).getId());
    }
