...
public class Transformers implements Serializable {
    ...
    public Transformers id(String id) {
        this.setId(id);
        return this;
    }
    ...
    // 删除原有的 uuid 相关方法
    // public UUID getUuid() { ... }
    // public Transformers uuid(UUID uuid) { ... }
    // public void setUuid(UUID uuid) { ... }
    public String getPartNumber() {
        return this.partNumber;
    }

    public Transformers partNumber(String partNumber) {
    ...
    public Transformers partType(String partType) {
    ...
    public Transformers value(String value) {
        this.setValue(value);
        return this;
    }
    ...
    public Transformers schematicPart(String schematicPart) {
    ...
    public Transformers ratingVoltage(String ratingVoltage) {
    ...
    public Transformers ratingElectricity(String ratingElectricity) {
    ...
    public Transformers characteristics(String characteristics) {
    ...
    public Transformers tolerance(String tolerance) {
    ...
    public Transformers manufacture(String manufacture) {
    ...
    public Transformers bCode(String bCode) {
        this.setbCode(bCode);
        return this;
    }
    ...
    public Transformers partsName(String partsName) {
    ...
    public Transformers itemRegistrationClassification(String itemRegistrationClassification) {
    ...
    public Transformers spiceModel(String spiceModel) {
    ...
    public Transformers pcbFootPrint(String pcbFootPrint) {
    ...
    public Transformers delFlag(Boolean delFlag) {
    ...
    public Transformers remark(String remark) {
    ...
    public Transformers createBy(String createBy) {
    ...
    public Transformers createTime(Instant createTime) {
    ...
    public Transformers updateBy(String updateBy) {
    ...
    public Transformers updateTime(Instant updateTime) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Transformers)) {
            return false;
        }
        return getId() != null && getId().equals(((Transformers) o).getId());
    }
