...
public class Resistors implements Serializable {
    ...
    // 删除原有的 uuid 相关方法
    // public UUID getUuid() { ... }
    // public Resistors uuid(UUID uuid) { ... }
    // public void setUuid(UUID uuid) { ... }
    public String getPartNumber() {
        return this.partNumber;
    }

    public Resistors partNumber(String partNumber) {
    ...
    public Resistors partType(String partType) {
    ...
    public Resistors value(String value) {
        this.setValue(value);
        return this;
    }
    ...
    public Resistors schematicPart(String schematicPart) {
    ...
    public Resistors ratingVoltage(String ratingVoltage) {
    ...
    public Resistors ratingElectricity(String ratingElectricity) {
    ...
    public Resistors characteristics(String characteristics) {
    ...
    public Resistors tolerance(String tolerance) {
    ...
    public Resistors manufacture(String manufacture) {
    ...
    public Resistors bCode(String bCode) {
        this.setbCode(bCode);
        return this;
    }
    ...
    public Resistors partsName(String partsName) {
    ...
    public Resistors itemRegistrationClassification(String itemRegistrationClassification) {
    ...
    public Resistors spiceModel(String spiceModel) {
    ...
    public Resistors pcbFootPrint(String pcbFootPrint) {
    ...
    public Resistors delFlag(Boolean delFlag) {
    ...
    public Resistors remark(String remark) {
    ...
    public Resistors createBy(String createBy) {
    ...
    public Resistors createTime(Instant createTime) {
    ...
    public Resistors updateBy(String updateBy) {
    ...
    public Resistors updateTime(Instant updateTime) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Resistors)) {
            return false;
        }
        return getId() != null && getId().equals(((Resistors) o).getId());
    }
