...
/**
 * A OrganicElectroluminescentDisplay.
 */
@Entity
@Table(name = "organic_electroluminescent_display")
@SuppressWarnings("common-java:DuplicatedBlocks")
public class OrganicElectroluminescentDisplay implements Serializable {
    ...
    public OrganicElectroluminescentDisplay id(String id) {
        this.setId(id);
        return this;
    }
    ...
    // 删除原有的 uuid 相关方法
    // public UUID getUuid() { ... }
    // public OrganicElectroluminescentDisplay uuid(UUID uuid) { ... }
    // public void setUuid(UUID uuid) { ... }
    public String getPartNumber() {
        return this.partNumber;
    }

    public OrganicElectroluminescentDisplay partNumber(String partNumber) {
    ...
    public OrganicElectroluminescentDisplay partType(String partType) {
    ...
    public OrganicElectroluminescentDisplay value(String value) {
        this.setValue(value);
        return this;
    }
    ...
    public OrganicElectroluminescentDisplay schematicPart(String schematicPart) {
    ...
    public OrganicElectroluminescentDisplay ratingVoltage(String ratingVoltage) {
    ...
    public OrganicElectroluminescentDisplay ratingElectricity(String ratingElectricity) {
    ...
    public OrganicElectroluminescentDisplay characteristics(String characteristics) {
    ...
    public OrganicElectroluminescentDisplay tolerance(String tolerance) {
    ...
    public OrganicElectroluminescentDisplay manufacture(String manufacture) {
    ...
    public OrganicElectroluminescentDisplay bCode(String bCode) {
        this.setbCode(bCode);
        return this;
    }
    ...
    public OrganicElectroluminescentDisplay partsName(String partsName) {
    ...
    public OrganicElectroluminescentDisplay itemRegistrationClassification(String itemRegistrationClassification) {
    ...
    public OrganicElectroluminescentDisplay spiceModel(String spiceModel) {
    ...
    public OrganicElectroluminescentDisplay pcbFootPrint(String pcbFootPrint) {
    ...
    public OrganicElectroluminescentDisplay delFlag(Boolean delFlag) {
    ...
    public OrganicElectroluminescentDisplay remark(String remark) {
    ...
    public OrganicElectroluminescentDisplay createBy(String createBy) {
    ...
    public OrganicElectroluminescentDisplay createTime(Instant createTime) {
    ...
    public OrganicElectroluminescentDisplay updateBy(String updateBy) {
    ...
    public OrganicElectroluminescentDisplay updateTime(Instant updateTime) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OrganicElectroluminescentDisplay)) {
            return false;
        }
        return getId() != null && getId().equals(((OrganicElectroluminescentDisplay) o).getId());
    }
    ...
    public String toString() {
        return "OrganicElectroluminescentDisplay{" +
            "id=" + getId() +
