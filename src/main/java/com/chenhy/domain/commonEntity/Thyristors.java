 ...
 */
@Entity
@Table(name = "thyristors")
@SuppressWarnings("common-java:DuplicatedBlocks")
public class Thyristors implements Serializable {
    ...
    public Thyristors id(String id) {
        this.setId(id);
        return this;
    }
    ...
    // 删除原有的 uuid 相关方法
    // public UUID getUuid() { ... }
    // public Thyristors uuid(UUID uuid) { ... }
    // public void setUuid(UUID uuid) { ... }
    public String getPartNumber() {
        return this.partNumber;
    }

    public Thyristors partNumber(String partNumber) {
    ...
    public Thyristors partType(String partType) {
    ...
    public Thyristors value(String value) {
        this.setValue(value);
        return this;
    }
    ...
    public Thyristors schematicPart(String schematicPart) {
    ...
    public Thyristors ratingVoltage(String ratingVoltage) {
    ...
    public Thyristors ratingElectricity(String ratingElectricity) {
    ...
    public Thyristors characteristics(String characteristics) {
    ...
    public Thyristors tolerance(String tolerance) {
    ...
    public Thyristors manufacture(String manufacture) {
    ...
    public Thyristors bCode(String bCode) {
        this.setbCode(bCode);
        return this;
    }
    ...
    public Thyristors partsName(String partsName) {
    ...
    public Thyristors itemRegistrationClassification(String itemRegistrationClassification) {
    ...
    public Thyristors spiceModel(String spiceModel) {
    ...
    public Thyristors pcbFootPrint(String pcbFootPrint) {
    ...
    public Thyristors delFlag(Boolean delFlag) {
    ...
    public Thyristors remark(String remark) {
    ...
    public Thyristors createBy(String createBy) {
    ...
    public Thyristors createTime(Instant createTime) {
    ...
    public Thyristors updateBy(String updateBy) {
    ...
    public Thyristors updateTime(Instant updateTime) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Thyristors)) {
            return false;
        }
        return getId() != null && getId().equals(((Thyristors) o).getId());
    }
