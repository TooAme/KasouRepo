...
public class Connectors implements Serializable {
    ...
    public Connectors id(String id) {
        this.setId(id);
        return this;
    }
    ...
    // 删除原有的 uuid 相关方法
    // public UUID getUuid() { ... }
    // public Connectors uuid(UUID uuid) { ... }
    // public void setUuid(UUID uuid) { ... }
    public String getPartNumber() {
        return this.partNumber;
    }

    public Connectors partNumber(String partNumber) {
    ...
    public Connectors partType(String partType) {
    ...
    public Connectors value(String value) {
        this.setValue(value);
        return this;
    }
    ...
    public Connectors schematicPart(String schematicPart) {
    ...
    public Connectors ratingVoltage(String ratingVoltage) {
    ...
    public Connectors ratingElectricity(String ratingElectricity) {
    ...
    public Connectors characteristics(String characteristics) {
    ...
    public Connectors tolerance(String tolerance) {
    ...
    public Connectors manufacture(String manufacture) {
    ...
    public Connectors bCode(String bCode) {
        this.setbCode(bCode);
        return this;
    }
    ...
    public Connectors partsName(String partsName) {
    ...
    public Connectors itemRegistrationClassification(String itemRegistrationClassification) {
    ...
    public Connectors spiceModel(String spiceModel) {
    ...
    public Connectors pcbFootPrint(String pcbFootPrint) {
    ...
    public Connectors delFlag(Boolean delFlag) {
    ...
    public Connectors remark(String remark) {
    ...
    public Connectors createBy(String createBy) {
    ...
    public Connectors createTime(Instant createTime) {
    ...
    public Connectors updateBy(String updateBy) {
    ...
    public Connectors updateTime(Instant updateTime) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Connectors)) {
            return false;
        }
        return getId() != null && getId().equals(((Connectors) o).getId());
    }
