...
public class Capacitors implements Serializable {
    ...
    public Capacitors id(String id) {
        this.setId(id);
        return this;
    }
    ...
    // 删除原有的 uuid 相关方法
    // public UUID getUuid() { ... }
    // public Capacitors uuid(UUID uuid) { ... }
    // public void setUuid(UUID uuid) { ... }
    public String getPartNumber() {
        return this.partNumber;
    }

    public Capacitors partNumber(String partNumber) {
    ...
    public Capacitors partType(String partType) {
    ...
    public Capacitors value(String value) {
        this.setValue(value);
        return this;
    }
    ...
    public Capacitors schematicPart(String schematicPart) {
    ...
    public Capacitors ratingVoltage(String ratingVoltage) {
    ...
    public Capacitors ratingElectricity(String ratingElectricity) {
    ...
    public Capacitors characteristics(String characteristics) {
    ...
    public Capacitors tolerance(String tolerance) {
    ...
    public Capacitors manufacture(String manufacture) {
    ...
    public Capacitors bCode(String bCode) {
        this.setbCode(bCode);
        return this;
    }
    ...
    public Capacitors partsName(String partsName) {
    ...
    public Capacitors itemRegistrationClassification(String itemRegistrationClassification) {
    ...
    public Capacitors spiceModel(String spiceModel) {
    ...
    public Capacitors pcbFootPrint(String pcbFootPrint) {
    ...
    public Capacitors delFlag(Boolean delFlag) {
    ...
    public Capacitors remark(String remark) {
    ...
    public Capacitors createBy(String createBy) {
    ...
    public Capacitors createTime(Instant createTime) {
    ...
    public Capacitors updateBy(String updateBy) {
    ...
    public Capacitors updateTime(Instant updateTime) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Capacitors)) {
            return false;
        }
        return getId() != null && getId().equals(((Capacitors) o).getId());
    }
