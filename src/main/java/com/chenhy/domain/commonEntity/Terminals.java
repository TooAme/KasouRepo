...
public class Terminals implements Serializable {
    ...
    // 删除原有的 uuid 相关方法
    // public UUID getUuid() { ... }
    // public Terminals uuid(UUID uuid) { ... }
    // public void setUuid(UUID uuid) { ... }
    public String getPartNumber() {
        return this.partNumber;
    }

    public Terminals partNumber(String partNumber) {
    ...
    public Terminals partType(String partType) {
    ...
    public Terminals value(String value) {
        this.setValue(value);
        return this;
    }
    ...
    public Terminals schematicPart(String schematicPart) {
    ...
    public Terminals ratingVoltage(String ratingVoltage) {
    ...
    public Terminals ratingElectricity(String ratingElectricity) {
    ...
    public Terminals characteristics(String characteristics) {
    ...
    public Terminals tolerance(String tolerance) {
    ...
    public Terminals manufacture(String manufacture) {
    ...
    public Terminals bCode(String bCode) {
        this.setbCode(bCode);
        return this;
    }
    ...
    public Terminals partsName(String partsName) {
    ...
    public Terminals itemRegistrationClassification(String itemRegistrationClassification) {
    ...
    public Terminals spiceModel(String spiceModel) {
    ...
    public Terminals pcbFootPrint(String pcbFootPrint) {
    ...
    public Terminals delFlag(Boolean delFlag) {
    ...
    public Terminals remark(String remark) {
    ...
    public Terminals createBy(String createBy) {
    ...
    public Terminals createTime(Instant createTime) {
    ...
    public Terminals updateBy(String updateBy) {
    ...
    public Terminals updateTime(Instant updateTime) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Terminals)) {
            return false;
        }
        return getId() != null && getId().equals(((Terminals) o).getId());
    }
