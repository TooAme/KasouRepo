...
public class Memories implements Serializable {
    ...
    // 删除原有的 uuid 相关方法
    // public UUID getUuid() { ... }
    // public Memories uuid(UUID uuid) { ... }
    // public void setUuid(UUID uuid) { ... }
    public String getPartNumber() {
        return this.partNumber;
    }

    public Memories partNumber(String partNumber) {
    ...
    public Memories partType(String partType) {
    ...
    public Memories value(String value) {
        this.setValue(value);
        return this;
    }
    ...
    public Memories schematicPart(String schematicPart) {
    ...
    public Memories ratingVoltage(String ratingVoltage) {
    ...
    public Memories ratingElectricity(String ratingElectricity) {
    ...
    public Memories characteristics(String characteristics) {
    ...
    public Memories tolerance(String tolerance) {
    ...
    public Memories manufacture(String manufacture) {
    ...
    public Memories bCode(String bCode) {
        this.setbCode(bCode);
        return this;
    }
    ...
    public Memories partsName(String partsName) {
    ...
    public Memories itemRegistrationClassification(String itemRegistrationClassification) {
    ...
    public Memories spiceModel(String spiceModel) {
    ...
    public Memories pcbFootPrint(String pcbFootPrint) {
    ...
    public Memories delFlag(Boolean delFlag) {
    ...
    public Memories remark(String remark) {
    ...
    public Memories createBy(String createBy) {
    ...
    public Memories createTime(Instant createTime) {
    ...
    public Memories updateBy(String updateBy) {
    ...
    public Memories updateTime(Instant updateTime) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Memories)) {
            return false;
        }
        return getId() != null && getId().equals(((Memories) o).getId());
    }
