...
public class Lamps implements Serializable {
    ...
    // 删除原有的 uuid 相关方法
    // public UUID getUuid() { ... }
    // public Lamps uuid(UUID uuid) { ... }
    // public void setUuid(UUID uuid) { ... }
    public String getPartNumber() {
        return this.partNumber;
    }

    public Lamps partNumber(String partNumber) {
    ...
    public Lamps partType(String partType) {
    ...
    public Lamps value(String value) {
        this.setValue(value);
        return this;
    }
    ...
    public Lamps schematicPart(String schematicPart) {
    ...
    public Lamps ratingVoltage(String ratingVoltage) {
    ...
    public Lamps ratingElectricity(String ratingElectricity) {
    ...
    public Lamps characteristics(String characteristics) {
    ...
    public Lamps tolerance(String tolerance) {
    ...
    public Lamps manufacture(String manufacture) {
    ...
    public Lamps bCode(String bCode) {
        this.setbCode(bCode);
        return this;
    }
    ...
    public Lamps partsName(String partsName) {
    ...
    public Lamps itemRegistrationClassification(String itemRegistrationClassification) {
    ...
    public Lamps spiceModel(String spiceModel) {
    ...
    public Lamps pcbFootPrint(String pcbFootPrint) {
    ...
    public Lamps delFlag(Boolean delFlag) {
    ...
    public Lamps remark(String remark) {
    ...
    public Lamps createBy(String createBy) {
    ...
    public Lamps createTime(Instant createTime) {
    ...
    public Lamps updateBy(String updateBy) {
    ...
    public Lamps updateTime(Instant updateTime) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Lamps)) {
            return false;
        }
        return getId() != null && getId().equals(((Lamps) o).getId());
    }
