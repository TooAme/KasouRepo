 ...
 */
@Entity
@Table(name = "delay_lines")
@SuppressWarnings("common-java:DuplicatedBlocks")
public class DelayLines implements Serializable {
    ...
    public DelayLines id(String id) {
        this.setId(id);
        return this;
    }
    ...
    // 删除原有的 uuid 相关方法
    // public UUID getUuid() { ... }
    // public DelayLines uuid(UUID uuid) { ... }
    // public void setUuid(UUID uuid) { ... }
    public String getPartNumber() {
        return this.partNumber;
    }

    public DelayLines partNumber(String partNumber) {
    ...
    public DelayLines partType(String partType) {
    ...
    public DelayLines value(String value) {
        this.setValue(value);
        return this;
    }
    ...
    public DelayLines schematicPart(String schematicPart) {
    ...
    public DelayLines ratingVoltage(String ratingVoltage) {
    ...
    public DelayLines ratingElectricity(String ratingElectricity) {
    ...
    public DelayLines characteristics(String characteristics) {
    ...
    public DelayLines tolerance(String tolerance) {
    ...
    public DelayLines manufacture(String manufacture) {
    ...
    public DelayLines bCode(String bCode) {
        this.setbCode(bCode);
        return this;
    }
    ...
    public DelayLines partsName(String partsName) {
    ...
    public DelayLines itemRegistrationClassification(String itemRegistrationClassification) {
    ...
    public DelayLines spiceModel(String spiceModel) {
    ...
    public DelayLines pcbFootPrint(String pcbFootPrint) {
    ...
    public DelayLines delFlag(Boolean delFlag) {
    ...
    public DelayLines remark(String remark) {
    ...
    public DelayLines createBy(String createBy) {
    ...
    public DelayLines createTime(Instant createTime) {
    ...
    public DelayLines updateBy(String updateBy) {
    ...
    public DelayLines updateTime(Instant updateTime) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DelayLines)) {
            return false;
        }
        return getId() != null && getId().equals(((DelayLines) o).getId());
    }
