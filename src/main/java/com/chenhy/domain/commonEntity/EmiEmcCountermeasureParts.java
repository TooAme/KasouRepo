...
/**
 * A EmiEmcCountermeasureParts.
 */
@Entity
@Table(name = "emi_emc_countermeasure_parts")
@SuppressWarnings("common-java:DuplicatedBlocks")
public class EmiEmcCountermeasureParts implements Serializable {
    ...
    public EmiEmcCountermeasureParts id(String id) {
        this.setId(id);
        return this;
    }
    ...
    // 删除原有的 uuid 相关方法
    // public UUID getUuid() { ... }
    // public EmiEmcCountermeasureParts uuid(UUID uuid) { ... }
    // public void setUuid(UUID uuid) { ... }
    public String getPartNumber() {
        return this.partNumber;
    }

    public EmiEmcCountermeasureParts partNumber(String partNumber) {
    ...
    public EmiEmcCountermeasureParts partType(String partType) {
    ...
    public EmiEmcCountermeasureParts value(String value) {
        this.setValue(value);
        return this;
    }
    ...
    public EmiEmcCountermeasureParts schematicPart(String schematicPart) {
    ...
    public EmiEmcCountermeasureParts ratingVoltage(String ratingVoltage) {
    ...
    public EmiEmcCountermeasureParts ratingElectricity(String ratingElectricity) {
    ...
    public EmiEmcCountermeasureParts characteristics(String characteristics) {
    ...
    public EmiEmcCountermeasureParts tolerance(String tolerance) {
    ...
    public EmiEmcCountermeasureParts manufacture(String manufacture) {
    ...
    public EmiEmcCountermeasureParts bCode(String bCode) {
        this.setbCode(bCode);
        return this;
    }
    ...
    public EmiEmcCountermeasureParts partsName(String partsName) {
    ...
    public EmiEmcCountermeasureParts itemRegistrationClassification(String itemRegistrationClassification) {
    ...
    public EmiEmcCountermeasureParts spiceModel(String spiceModel) {
    ...
    public EmiEmcCountermeasureParts pcbFootPrint(String pcbFootPrint) {
    ...
    public EmiEmcCountermeasureParts delFlag(Boolean delFlag) {
    ...
    public EmiEmcCountermeasureParts remark(String remark) {
    ...
    public EmiEmcCountermeasureParts createBy(String createBy) {
    ...
    public EmiEmcCountermeasureParts createTime(Instant createTime) {
    ...
    public EmiEmcCountermeasureParts updateBy(String updateBy) {
    ...
    public EmiEmcCountermeasureParts updateTime(Instant updateTime) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EmiEmcCountermeasureParts)) {
            return false;
        }
        return getId() != null && getId().equals(((EmiEmcCountermeasureParts) o).getId());
    }
    ...
    public String toString() {
        return "EmiEmcCountermeasureParts{" +
            "id=" + getId() +
