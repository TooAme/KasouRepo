...
/**
 * A FunctionCircuitModules.
 */
@Entity
@Table(name = "function_circuit_modules")
@SuppressWarnings("common-java:DuplicatedBlocks")
public class FunctionCircuitModules implements Serializable {
    ...
    public FunctionCircuitModules id(String id) {
        this.setId(id);
        return this;
    }
    ...
    // 删除原有的 uuid 相关方法
    // public UUID getUuid() { ... }
    // public FunctionCircuitModules uuid(UUID uuid) { ... }
    // public void setUuid(UUID uuid) { ... }
    public String getPartNumber() {
        return this.partNumber;
    }

    public FunctionCircuitModules partNumber(String partNumber) {
    ...
    public FunctionCircuitModules partType(String partType) {
    ...
    public FunctionCircuitModules value(String value) {
        this.setValue(value);
        return this;
    }
    ...
    public FunctionCircuitModules schematicPart(String schematicPart) {
    ...
    public FunctionCircuitModules ratingVoltage(String ratingVoltage) {
    ...
    public FunctionCircuitModules ratingElectricity(String ratingElectricity) {
    ...
    public FunctionCircuitModules characteristics(String characteristics) {
    ...
    public FunctionCircuitModules tolerance(String tolerance) {
    ...
    public FunctionCircuitModules manufacture(String manufacture) {
    ...
    public FunctionCircuitModules bCode(String bCode) {
        this.setbCode(bCode);
        return this;
    }
    ...
    public FunctionCircuitModules partsName(String partsName) {
    ...
    public FunctionCircuitModules itemRegistrationClassification(String itemRegistrationClassification) {
    ...
    public FunctionCircuitModules spiceModel(String spiceModel) {
    ...
    public FunctionCircuitModules pcbFootPrint(String pcbFootPrint) {
    ...
    public FunctionCircuitModules delFlag(Boolean delFlag) {
    ...
    public FunctionCircuitModules remark(String remark) {
    ...
    public FunctionCircuitModules createBy(String createBy) {
    ...
    public FunctionCircuitModules createTime(Instant createTime) {
    ...
    public FunctionCircuitModules updateBy(String updateBy) {
    ...
    public FunctionCircuitModules updateTime(Instant updateTime) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FunctionCircuitModules)) {
            return false;
        }
        return getId() != null && getId().equals(((FunctionCircuitModules) o).getId());
    }
