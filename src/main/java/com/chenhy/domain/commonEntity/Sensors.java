...
public class Sensors implements Serializable {
    ...
    // 删除原有的 uuid 相关方法
    // public UUID getUuid() { ... }
    // public Sensors uuid(UUID uuid) { ... }
    // public void setUuid(UUID uuid) { ... }
    public String getPartNumber() {
        return this.partNumber;
    }

    public Sensors partNumber(String partNumber) {
    ...
    public Sensors partType(String partType) {
    ...
    public Sensors value(String value) {
        this.setValue(value);
        return this;
    }
    ...
    public Sensors schematicPart(String schematicPart) {
    ...
    public Sensors ratingVoltage(String ratingVoltage) {
    ...
    public Sensors ratingElectricity(String ratingElectricity) {
    ...
    public Sensors characteristics(String characteristics) {
    ...
    public Sensors tolerance(String tolerance) {
    ...
    public Sensors manufacture(String manufacture) {
    ...
    public Sensors bCode(String bCode) {
        this.setbCode(bCode);
        return this;
    }
    ...
    public Sensors partsName(String partsName) {
    ...
    public Sensors itemRegistrationClassification(String itemRegistrationClassification) {
    ...
    public Sensors spiceModel(String spiceModel) {
    ...
    public Sensors pcbFootPrint(String pcbFootPrint) {
    ...
    public Sensors delFlag(Boolean delFlag) {
    ...
    public Sensors remark(String remark) {
    ...
    public Sensors createBy(String createBy) {
    ...
    public Sensors createTime(Instant createTime) {
    ...
    public Sensors updateBy(String updateBy) {
    ...
    public Sensors updateTime(Instant updateTime) {
    ...
    public boolean equals(Object o) {
        ...
        return getId() != null && getId().equals(((Sensors) o).getId());
    }
