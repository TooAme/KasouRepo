...
public class Oscillators implements Serializable {
    ...
    public Oscillators id(String id) {
        this.setId(id);
        return this;
    }
    ...
    // 删除原有的 uuid 相关方法
    // public UUID getUuid() { ... }
    // public Oscillators uuid(UUID uuid) { ... }
    // public void setUuid(UUID uuid) { ... }
    public String getPartNumber() {
        return this.partNumber;
    }

    public Oscillators partNumber(String partNumber) {
    ...
    public Oscillators partType(String partType) {
    ...
    public Oscillators value(String value) {
        this.setValue(value);
        return this;
    }
    ...
    public Oscillators schematicPart(String schematicPart) {
    ...
    public Oscillators ratingVoltage(String ratingVoltage) {
    ...
    public Oscillators ratingElectricity(String ratingElectricity) {
    ...
    public Oscillators characteristics(String characteristics) {
    ...
    public Oscillators tolerance(String tolerance) {
    ...
    public Oscillators manufacture(String manufacture) {
    ...
    public Oscillators bCode(String bCode) {
        this.setbCode(bCode);
        return this;
    }
    ...
    public Oscillators partsName(String partsName) {
    ...
    public Oscillators itemRegistrationClassification(String itemRegistrationClassification) {
    ...
    public Oscillators spiceModel(String spiceModel) {
    ...
    public Oscillators pcbFootPrint(String pcbFootPrint) {
    ...
    public Oscillators delFlag(Boolean delFlag) {
    ...
    public Oscillators remark(String remark) {
    ...
    public Oscillators createBy(String createBy) {
    ...
    public Oscillators createTime(Instant createTime) {
    ...
    public Oscillators updateBy(String updateBy) {
    ...
    public Oscillators updateTime(Instant updateTime) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Oscillators)) {
            return false;
        }
        return getId() != null && getId().equals(((Oscillators) o).getId());
    }
