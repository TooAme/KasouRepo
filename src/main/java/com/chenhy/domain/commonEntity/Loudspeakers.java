 ...
 */
@Entity
@Table(name = "loudspeakers")
@SuppressWarnings("common-java:DuplicatedBlocks")
public class Loudspeakers implements Serializable {
    ...
    public Loudspeakers id(String id) {
        this.setId(id);
        return this;
    }
    ...
    // 删除原有的 uuid 相关方法
    // public UUID getUuid() { ... }
    // public Loudspeakers uuid(UUID uuid) { ... }
    // public void setUuid(UUID uuid) { ... }
    public String getPartNumber() {
        return this.partNumber;
    }

    public Loudspeakers partNumber(String partNumber) {
    ...
    public Loudspeakers partType(String partType) {
    ...
    public Loudspeakers value(String value) {
        this.setValue(value);
        return this;
    }
    ...
    public Loudspeakers schematicPart(String schematicPart) {
    ...
    public Loudspeakers ratingVoltage(String ratingVoltage) {
    ...
    public Loudspeakers ratingElectricity(String ratingElectricity) {
    ...
    public Loudspeakers characteristics(String characteristics) {
    ...
    public Loudspeakers tolerance(String tolerance) {
    ...
    public Loudspeakers manufacture(String manufacture) {
    ...
    public Loudspeakers bCode(String bCode) {
        this.setbCode(bCode);
        return this;
    }
    ...
    public Loudspeakers partsName(String partsName) {
    ...
    public Loudspeakers itemRegistrationClassification(String itemRegistrationClassification) {
    ...
    public Loudspeakers spiceModel(String spiceModel) {
    ...
    public Loudspeakers pcbFootPrint(String pcbFootPrint) {
    ...
    public Loudspeakers delFlag(Boolean delFlag) {
    ...
    public Loudspeakers remark(String remark) {
    ...
    public Loudspeakers createBy(String createBy) {
    ...
    public Loudspeakers createTime(Instant createTime) {
    ...
    public Loudspeakers updateBy(String updateBy) {
    ...
    public Loudspeakers updateTime(Instant updateTime) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Loudspeakers)) {
            return false;
        }
        return getId() != null && getId().equals(((Loudspeakers) o).getId());
    }
