...
public class Diodes implements Serializable {
    ...
    // 删除原有的 uuid 相关方法
    // public UUID getUuid() { ... }
    // public Diodes uuid(UUID uuid) { ... }
    // public void setUuid(UUID uuid) { ... }
    public String getPartNumber() {
        return this.partNumber;
    }

    public Diodes partNumber(String partNumber) {
    ...
    public Diodes partType(String partType) {
    ...
    public Diodes value(String value) {
        this.setValue(value);
        return this;
    }
    ...
    public Diodes schematicPart(String schematicPart) {
    ...
    public Diodes ratingVoltage(String ratingVoltage) {
    ...
    public Diodes ratingElectricity(String ratingElectricity) {
    ...
    public Diodes characteristics(String characteristics) {
    ...
    public Diodes tolerance(String tolerance) {
    ...
    public Diodes manufacture(String manufacture) {
    ...
    public Diodes bCode(String bCode) {
        this.setbCode(bCode);
        return this;
    }
    ...
    public Diodes partsName(String partsName) {
    ...
    public Diodes itemRegistrationClassification(String itemRegistrationClassification) {
    ...
    public Diodes spiceModel(String spiceModel) {
    ...
    public Diodes pcbFootPrint(String pcbFootPrint) {
    ...
    public Diodes delFlag(Boolean delFlag) {
    ...
    public Diodes remark(String remark) {
    ...
    public Diodes createBy(String createBy) {
    ...
    public Diodes createTime(Instant createTime) {
    ...
    public Diodes updateBy(String updateBy) {
    ...
    public Diodes updateTime(Instant updateTime) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Diodes)) {
            return false;
        }
        return getId() != null && getId().equals(((Diodes) o).getId());
    }
