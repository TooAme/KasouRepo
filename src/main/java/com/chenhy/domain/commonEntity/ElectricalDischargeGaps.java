...
/**
 * A ElectricalDischargeGaps.
 */
@Entity
@Table(name = "electrical_discharge_gaps")
@SuppressWarnings("common-java:DuplicatedBlocks")
public class ElectricalDischargeGaps implements Serializable {
    ...
    public ElectricalDischargeGaps id(String id) {
        this.setId(id);
        return this;
    }
    ...
    // 删除原有的 uuid 相关方法
    // public UUID getUuid() { ... }
    // public ElectricalDischargeGaps uuid(UUID uuid) { ... }
    // public void setUuid(UUID uuid) { ... }
    public String getPartNumber() {
        return this.partNumber;
    }

    public ElectricalDischargeGaps partNumber(String partNumber) {
    ...
    public ElectricalDischargeGaps partType(String partType) {
    ...
    public ElectricalDischargeGaps value(String value) {
        this.setValue(value);
        return this;
    }
    ...
    public ElectricalDischargeGaps schematicPart(String schematicPart) {
    ...
    public ElectricalDischargeGaps ratingVoltage(String ratingVoltage) {
    ...
    public ElectricalDischargeGaps ratingElectricity(String ratingElectricity) {
    ...
    public ElectricalDischargeGaps characteristics(String characteristics) {
    ...
    public ElectricalDischargeGaps tolerance(String tolerance) {
    ...
    public ElectricalDischargeGaps manufacture(String manufacture) {
    ...
    public ElectricalDischargeGaps bCode(String bCode) {
        this.setbCode(bCode);
        return this;
    }
    ...
    public ElectricalDischargeGaps partsName(String partsName) {
    ...
    public ElectricalDischargeGaps itemRegistrationClassification(String itemRegistrationClassification) {
    ...
    public ElectricalDischargeGaps spiceModel(String spiceModel) {
    ...
    public ElectricalDischargeGaps pcbFootPrint(String pcbFootPrint) {
    ...
    public ElectricalDischargeGaps delFlag(Boolean delFlag) {
    ...
    public ElectricalDischargeGaps remark(String remark) {
    ...
    public ElectricalDischargeGaps createBy(String createBy) {
    ...
    public ElectricalDischargeGaps createTime(Instant createTime) {
    ...
    public ElectricalDischargeGaps updateBy(String updateBy) {
    ...
    public ElectricalDischargeGaps updateTime(Instant updateTime) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ElectricalDischargeGaps)) {
            return false;
        }
        return getId() != null && getId().equals(((ElectricalDischargeGaps) o).getId());
    }
    ...
    public String toString() {
        return "ElectricalDischargeGaps{" +
            "id=" + getId() +
