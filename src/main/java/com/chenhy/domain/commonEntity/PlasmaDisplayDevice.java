...
/**
 * A PlasmaDisplayDevice.
 */
@Entity
@Table(name = "plasma_display_device")
@SuppressWarnings("common-java:DuplicatedBlocks")
public class PlasmaDisplayDevice implements Serializable {
    ...
    public PlasmaDisplayDevice id(String id) {
        this.setId(id);
        return this;
    }
    ...
    // 删除原有的 uuid 相关方法
    // public UUID getUuid() { ... }
    // public PlasmaDisplayDevice uuid(UUID uuid) { ... }
    // public void setUuid(UUID uuid) { ... }
    public String getPartNumber() {
        return this.partNumber;
    }

    public PlasmaDisplayDevice partNumber(String partNumber) {
    ...
    public PlasmaDisplayDevice partType(String partType) {
    ...
    public PlasmaDisplayDevice value(String value) {
        this.setValue(value);
        return this;
    }
    ...
    public PlasmaDisplayDevice schematicPart(String schematicPart) {
    ...
    public PlasmaDisplayDevice ratingVoltage(String ratingVoltage) {
    ...
    public PlasmaDisplayDevice ratingElectricity(String ratingElectricity) {
    ...
    public PlasmaDisplayDevice characteristics(String characteristics) {
    ...
    public PlasmaDisplayDevice tolerance(String tolerance) {
    ...
    public PlasmaDisplayDevice manufacture(String manufacture) {
    ...
    public PlasmaDisplayDevice bCode(String bCode) {
        this.setbCode(bCode);
        return this;
    }
    ...
    public PlasmaDisplayDevice partsName(String partsName) {
    ...
    public PlasmaDisplayDevice itemRegistrationClassification(String itemRegistrationClassification) {
    ...
    public PlasmaDisplayDevice spiceModel(String spiceModel) {
    ...
    public PlasmaDisplayDevice pcbFootPrint(String pcbFootPrint) {
    ...
    public PlasmaDisplayDevice delFlag(Boolean delFlag) {
    ...
    public PlasmaDisplayDevice remark(String remark) {
    ...
    public PlasmaDisplayDevice createBy(String createBy) {
    ...
    public PlasmaDisplayDevice createTime(Instant createTime) {
    ...
    public PlasmaDisplayDevice updateBy(String updateBy) {
    ...
    public PlasmaDisplayDevice updateTime(Instant updateTime) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PlasmaDisplayDevice)) {
            return false;
        }
        return getId() != null && getId().equals(((PlasmaDisplayDevice) o).getId());
    }
