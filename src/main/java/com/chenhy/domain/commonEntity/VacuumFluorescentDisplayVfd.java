...
/**
 * A VacuumFluorescentDisplayVfd.
 */
@Entity
@Table(name = "vacuum_fluorescent_display_vfd")
@SuppressWarnings("common-java:DuplicatedBlocks")
public class VacuumFluorescentDisplayVfd implements Serializable {
    ...
    public VacuumFluorescentDisplayVfd id(String id) {
        this.setId(id);
        return this;
    }
    ...
    // 删除原有的 uuid 相关方法
    // public UUID getUuid() { ... }
    // public VacuumFluorescentDisplayVfd uuid(UUID uuid) { ... }
    // public void setUuid(UUID uuid) { ... }
    public String getPartNumber() {
        return this.partNumber;
    }

    public VacuumFluorescentDisplayVfd partNumber(String partNumber) {
    ...
    public VacuumFluorescentDisplayVfd partType(String partType) {
    ...
    public VacuumFluorescentDisplayVfd value(String value) {
        this.setValue(value);
        return this;
    }
    ...
    public VacuumFluorescentDisplayVfd schematicPart(String schematicPart) {
    ...
    public VacuumFluorescentDisplayVfd ratingVoltage(String ratingVoltage) {
    ...
    public VacuumFluorescentDisplayVfd ratingElectricity(String ratingElectricity) {
    ...
    public VacuumFluorescentDisplayVfd characteristics(String characteristics) {
    ...
    public VacuumFluorescentDisplayVfd tolerance(String tolerance) {
    ...
    public VacuumFluorescentDisplayVfd manufacture(String manufacture) {
    ...
    public VacuumFluorescentDisplayVfd bCode(String bCode) {
        this.setbCode(bCode);
        return this;
    }
    ...
    public VacuumFluorescentDisplayVfd partsName(String partsName) {
    ...
    public VacuumFluorescentDisplayVfd itemRegistrationClassification(String itemRegistrationClassification) {
    ...
    public VacuumFluorescentDisplayVfd spiceModel(String spiceModel) {
    ...
    public VacuumFluorescentDisplayVfd pcbFootPrint(String pcbFootPrint) {
    ...
    public VacuumFluorescentDisplayVfd delFlag(Boolean delFlag) {
    ...
    public VacuumFluorescentDisplayVfd remark(String remark) {
    ...
    public VacuumFluorescentDisplayVfd createBy(String createBy) {
    ...
    public VacuumFluorescentDisplayVfd createTime(Instant createTime) {
    ...
    public VacuumFluorescentDisplayVfd updateBy(String updateBy) {
    ...
    public VacuumFluorescentDisplayVfd updateTime(Instant updateTime) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VacuumFluorescentDisplayVfd)) {
            return false;
        }
        return getId() != null && getId().equals(((VacuumFluorescentDisplayVfd) o).getId());
    }
    ...
    public String toString() {
        return "VacuumFluorescentDisplayVfd{" +
            "id=" + getId() +
