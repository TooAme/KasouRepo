...
public class Transistors implements Serializable {
    ...
    public Transistors id(String id) {
        this.setId(id);
        return this;
    }
    ...
    // 删除原有的 uuid 相关方法
    // public UUID getUuid() { ... }
    // public Transistors uuid(UUID uuid) { ... }
    // public void setUuid(UUID uuid) { ... }
    public String getPartNumber() {
        return this.partNumber;
    }

    public Transistors partNumber(String partNumber) {
    ...
    public Transistors partType(String partType) {
    ...
    public Transistors value(String value) {
        this.setValue(value);
        return this;
    }
    ...
    public Transistors schematicPart(String schematicPart) {
    ...
    public Transistors ratingVoltage(String ratingVoltage) {
    ...
    public Transistors ratingElectricity(String ratingElectricity) {
    ...
    public Transistors characteristics(String characteristics) {
    ...
    public Transistors tolerance(String tolerance) {
    ...
    public Transistors manufacture(String manufacture) {
    ...
    public Transistors bCode(String bCode) {
        this.setbCode(bCode);
        return this;
    }
    ...
    public Transistors partsName(String partsName) {
    ...
    public Transistors itemRegistrationClassification(String itemRegistrationClassification) {
    ...
    public Transistors spiceModel(String spiceModel) {
    ...
    public Transistors pcbFootPrint(String pcbFootPrint) {
    ...
    public Transistors delFlag(Boolean delFlag) {
    ...
    public Transistors remark(String remark) {
    ...
    public Transistors createBy(String createBy) {
    ...
    public Transistors createTime(Instant createTime) {
    ...
    public Transistors updateBy(String updateBy) {
    ...
    public Transistors updateTime(Instant updateTime) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Transistors)) {
            return false;
        }
        return getId() != null && getId().equals(((Transistors) o).getId());
    }
