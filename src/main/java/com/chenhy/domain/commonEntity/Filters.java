...
public class Filters implements Serializable {
    ...
    // 删除原有的 uuid 相关方法
    // public UUID getUuid() { ... }
    // public Filters uuid(UUID uuid) { ... }
    // public void setUuid(UUID uuid) { ... }
    public String getPartNumber() {
        return this.partNumber;
    }

    public Filters partNumber(String partNumber) {
    ...
    public Filters partType(String partType) {
    ...
    public Filters value(String value) {
        this.setValue(value);
        return this;
    }
    ...
    public Filters schematicPart(String schematicPart) {
    ...
    public Filters ratingVoltage(String ratingVoltage) {
    ...
    public Filters ratingElectricity(String ratingElectricity) {
    ...
    public Filters characteristics(String characteristics) {
    ...
    public Filters tolerance(String tolerance) {
    ...
    public Filters manufacture(String manufacture) {
    ...
    public Filters bCode(String bCode) {
        this.setbCode(bCode);
        return this;
    }
    ...
    public Filters partsName(String partsName) {
    ...
    public Filters itemRegistrationClassification(String itemRegistrationClassification) {
    ...
    public Filters spiceModel(String spiceModel) {
    ...
    public Filters pcbFootPrint(String pcbFootPrint) {
    ...
    public Filters delFlag(Boolean delFlag) {
    ...
    public Filters remark(String remark) {
    ...
    public Filters createBy(String createBy) {
    ...
    public Filters createTime(Instant createTime) {
    ...
    public Filters updateBy(String updateBy) {
    ...
    public Filters updateTime(Instant updateTime) {
    ...
    public boolean equals(Object o) {
        ...
        return getId() != null && getId().equals(((Filters) o).getId());
    }
