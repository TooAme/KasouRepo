...
public class Resonators implements Serializable {
    ...
    public Resonators id(String id) {
        this.setId(id);
        return this;
    }
    ...
    // 删除原有的 uuid 相关方法
    // public UUID getUuid() { ... }
    // public Resonators uuid(UUID uuid) { ... }
    // public void setUuid(UUID uuid) { ... }
    public String getPartNumber() {
        return this.partNumber;
    }

    public Resonators partNumber(String partNumber) {
    ...
    public Resonators partType(String partType) {
    ...
    public Resonators value(String value) {
        this.setValue(value);
        return this;
    }
    ...
    public Resonators schematicPart(String schematicPart) {
    ...
    public Resonators ratingVoltage(String ratingVoltage) {
    ...
    public Resonators ratingElectricity(String ratingElectricity) {
    ...
    public Resonators characteristics(String characteristics) {
    ...
    public Resonators tolerance(String tolerance) {
    ...
    public Resonators manufacture(String manufacture) {
    ...
    public Resonators bCode(String bCode) {
        this.setbCode(bCode);
        return this;
    }
    ...
    public Resonators partsName(String partsName) {
    ...
    public Resonators itemRegistrationClassification(String itemRegistrationClassification) {
    ...
    public Resonators spiceModel(String spiceModel) {
    ...
    public Resonators pcbFootPrint(String pcbFootPrint) {
    ...
    public Resonators delFlag(Boolean delFlag) {
    ...
    public Resonators remark(String remark) {
    ...
    public Resonators createBy(String createBy) {
    ...
    public Resonators createTime(Instant createTime) {
    ...
    public Resonators updateBy(String updateBy) {
    ...
    public Resonators updateTime(Instant updateTime) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Resonators)) {
            return false;
        }
        return getId() != null && getId().equals(((Resonators) o).getId());
    }
