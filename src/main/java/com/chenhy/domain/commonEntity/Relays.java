...
public class Relays implements Serializable {
    ...
    // 删除原有的 uuid 相关方法
    // public UUID getUuid() { ... }
    // public Relays uuid(UUID uuid) { ... }
    // public void setUuid(UUID uuid) { ... }
    public String getPartNumber() {
        return this.partNumber;
    }

    public Relays partNumber(String partNumber) {
    ...
    public Relays partType(String partType) {
    ...
    public Relays value(String value) {
        this.setValue(value);
        return this;
    }
    ...
    public Relays schematicPart(String schematicPart) {
    ...
    public Relays ratingVoltage(String ratingVoltage) {
    ...
    public Relays ratingElectricity(String ratingElectricity) {
    ...
    public Relays characteristics(String characteristics) {
    ...
    public Relays tolerance(String tolerance) {
    ...
    public Relays manufacture(String manufacture) {
    ...
    public Relays bCode(String bCode) {
        this.setbCode(bCode);
        return this;
    }
    ...
    public Relays partsName(String partsName) {
    ...
    public Relays itemRegistrationClassification(String itemRegistrationClassification) {
    ...
    public Relays spiceModel(String spiceModel) {
    ...
    public Relays pcbFootPrint(String pcbFootPrint) {
    ...
    public Relays delFlag(Boolean delFlag) {
    ...
    public Relays remark(String remark) {
    ...
    public Relays createBy(String createBy) {
    ...
    public Relays createTime(Instant createTime) {
    ...
    public Relays updateBy(String updateBy) {
    ...
    public Relays updateTime(Instant updateTime) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Relays)) {
            return false;
        }
        return getId() != null && getId().equals(((Relays) o).getId());
    }
