 ...
 */
@Entity
@Table(name = "buzzers_sounders")
@SuppressWarnings("common-java:DuplicatedBlocks")
public class BuzzersSounders implements Serializable {
    ...
    public BuzzersSounders id(String id) {
        this.setId(id);
        return this;
    }
    ...
    // 删除原有的 uuid 相关方法
    // public UUID getUuid() { ... }
    // public BuzzersSounders uuid(UUID uuid) { ... }
    // public void setUuid(UUID uuid) { ... }
    public String getPartNumber() {
        return this.partNumber;
    }

    public BuzzersSounders partNumber(String partNumber) {
    ...
    public BuzzersSounders partType(String partType) {
    ...
    public BuzzersSounders value(String value) {
        this.setValue(value);
        return this;
    }
    ...
    public BuzzersSounders schematicPart(String schematicPart) {
    ...
    public BuzzersSounders ratingVoltage(String ratingVoltage) {
    ...
    public BuzzersSounders ratingElectricity(String ratingElectricity) {
    ...
    public BuzzersSounders characteristics(String characteristics) {
    ...
    public BuzzersSounders tolerance(String tolerance) {
    ...
    public BuzzersSounders manufacture(String manufacture) {
    ...
    public BuzzersSounders bCode(String bCode) {
        this.setbCode(bCode);
        return this;
    }
    ...
    public BuzzersSounders partsName(String partsName) {
    ...
    public BuzzersSounders itemRegistrationClassification(String itemRegistrationClassification) {
    ...
    public BuzzersSounders spiceModel(String spiceModel) {
    ...
    public BuzzersSounders pcbFootPrint(String pcbFootPrint) {
    ...
    public BuzzersSounders delFlag(Boolean delFlag) {
    ...
    public BuzzersSounders remark(String remark) {
    ...
    public BuzzersSounders createBy(String createBy) {
    ...
    public BuzzersSounders createTime(Instant createTime) {
    ...
    public BuzzersSounders updateBy(String updateBy) {
    ...
    public BuzzersSounders updateTime(Instant updateTime) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BuzzersSounders)) {
            return false;
        }
        return getId() != null && getId().equals(((BuzzersSounders) o).getId());
    }
