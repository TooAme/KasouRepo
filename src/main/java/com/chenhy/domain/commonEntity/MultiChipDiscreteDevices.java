...
/**
 * A MultiChipDiscreteDevices.
 */
@Entity
@Table(name = "multi_chip_discrete_devices")
@SuppressWarnings("common-java:DuplicatedBlocks")
public class MultiChipDiscreteDevices implements Serializable {
    ...
    public MultiChipDiscreteDevices id(String id) {
        this.setId(id);
        return this;
    }
    ...
    // 删除原有的 uuid 相关方法
    // public UUID getUuid() { ... }
    // public MultiChipDiscreteDevices uuid(UUID uuid) { ... }
    // public void setUuid(UUID uuid) { ... }
    public String getPartNumber() {
        return this.partNumber;
    }

    public MultiChipDiscreteDevices partNumber(String partNumber) {
    ...
    public MultiChipDiscreteDevices partType(String partType) {
    ...
    public MultiChipDiscreteDevices value(String value) {
        this.setValue(value);
        return this;
    }
    ...
    public MultiChipDiscreteDevices schematicPart(String schematicPart) {
    ...
    public MultiChipDiscreteDevices ratingVoltage(String ratingVoltage) {
    ...
    public MultiChipDiscreteDevices ratingElectricity(String ratingElectricity) {
    ...
    public MultiChipDiscreteDevices characteristics(String characteristics) {
    ...
    public MultiChipDiscreteDevices tolerance(String tolerance) {
    ...
    public MultiChipDiscreteDevices manufacture(String manufacture) {
    ...
    public MultiChipDiscreteDevices bCode(String bCode) {
        this.setbCode(bCode);
        return this;
    }
    ...
    public MultiChipDiscreteDevices partsName(String partsName) {
    ...
    public MultiChipDiscreteDevices itemRegistrationClassification(String itemRegistrationClassification) {
    ...
    public MultiChipDiscreteDevices spiceModel(String spiceModel) {
    ...
    public MultiChipDiscreteDevices pcbFootPrint(String pcbFootPrint) {
    ...
    public MultiChipDiscreteDevices delFlag(Boolean delFlag) {
    ...
    public MultiChipDiscreteDevices remark(String remark) {
    ...
    public MultiChipDiscreteDevices createBy(String createBy) {
    ...
    public MultiChipDiscreteDevices createTime(Instant createTime) {
    ...
    public MultiChipDiscreteDevices updateBy(String updateBy) {
    ...
    public MultiChipDiscreteDevices updateTime(Instant updateTime) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MultiChipDiscreteDevices)) {
            return false;
        }
        return getId() != null && getId().equals(((MultiChipDiscreteDevices) o).getId());
    }
    ...
    public String toString() {
        return "MultiChipDiscreteDevices{" +
            "id=" + getId() +
