 ...
 */
@Entity
@Table(name = "optical_parts")
@SuppressWarnings("common-java:DuplicatedBlocks")
public class OpticalParts implements Serializable {
    ...
    public OpticalParts id(String id) {
        this.setId(id);
        return this;
    }
    ...
    // 删除原有的 uuid 相关方法
    // public UUID getUuid() { ... }
    // public OpticalParts uuid(UUID uuid) { ... }
    // public void setUuid(UUID uuid) { ... }
    public String getPartNumber() {
        return this.partNumber;
    }

    public OpticalParts partNumber(String partNumber) {
    ...
    public OpticalParts partType(String partType) {
    ...
    public OpticalParts value(String value) {
        this.setValue(value);
        return this;
    }
    ...
    public OpticalParts schematicPart(String schematicPart) {
    ...
    public OpticalParts ratingVoltage(String ratingVoltage) {
    ...
    public OpticalParts ratingElectricity(String ratingElectricity) {
    ...
    public OpticalParts characteristics(String characteristics) {
    ...
    public OpticalParts tolerance(String tolerance) {
    ...
    public OpticalParts manufacture(String manufacture) {
    ...
    public OpticalParts bCode(String bCode) {
        this.setbCode(bCode);
        return this;
    }
    ...
    public OpticalParts partsName(String partsName) {
    ...
    public OpticalParts itemRegistrationClassification(String itemRegistrationClassification) {
    ...
    public OpticalParts spiceModel(String spiceModel) {
    ...
    public OpticalParts pcbFootPrint(String pcbFootPrint) {
    ...
    public OpticalParts delFlag(Boolean delFlag) {
    ...
    public OpticalParts remark(String remark) {
    ...
    public OpticalParts createBy(String createBy) {
    ...
    public OpticalParts createTime(Instant createTime) {
    ...
    public OpticalParts updateBy(String updateBy) {
    ...
    public OpticalParts updateTime(Instant updateTime) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OpticalParts)) {
            return false;
        }
        return getId() != null && getId().equals(((OpticalParts) o).getId());
    }
