...
public class Ics implements Serializable {
    ...
    // 删除原有的 uuid 相关方法
    // public UUID getUuid() { ... }
    // public Ics uuid(UUID uuid) { ... }
    // public void setUuid(UUID uuid) { ... }
    public String getPartNumber() {
        return this.partNumber;
    }

    public Ics partNumber(String partNumber) {
    ...
    public Ics partType(String partType) {
    ...
    public Ics schematicPart(String schematicPart) {
    ...
    public Ics ratingVoltage(String ratingVoltage) {
    ...
    public Ics ratingElectricity(String ratingElectricity) {
    ...
    public Ics characteristics(String characteristics) {
    ...
    public Ics tolerance(String tolerance) {
    ...
    public Ics manufacture(String manufacture) {
    ...
    public Ics partsName(String partsName) {
    ...
    public Ics itemRegistrationClassification(String itemRegistrationClassification) {
    ...
    public Ics spiceModel(String spiceModel) {
    ...
    public Ics pcbFootPrint(String pcbFootPrint) {
    ...
    public Ics delFlag(Boolean delFlag) {
    ...
    public Ics remark(String remark) {
    ...
    public Ics createBy(String createBy) {
    ...
    public Ics createTime(Instant createTime) {
    ...
    public Ics updateBy(String updateBy) {
    ...
    public Ics updateTime(Instant updateTime) {
    ...
    public boolean equals(Object o) {
        ...
        return getId() != null && getId().equals(((Ics) o).getId());
    }
