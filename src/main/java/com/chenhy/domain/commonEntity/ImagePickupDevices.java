...
/**
 * A ImagePickupDevices.
 */
@Entity
@Table(name = "image_pickup_devices")
@SuppressWarnings("common-java:DuplicatedBlocks")
public class ImagePickupDevices implements Serializable {
    ...
    public ImagePickupDevices id(String id) {
        this.setId(id);
        return this;
    }
    ...
    // 删除原有的 uuid 相关方法
    // public UUID getUuid() { ... }
    // public ImagePickupDevices uuid(UUID uuid) { ... }
    // public void setUuid(UUID uuid) { ... }
    public String getPartNumber() {
        return this.partNumber;
    }

    public ImagePickupDevices partNumber(String partNumber) {
    ...
    public ImagePickupDevices partType(String partType) {
    ...
    public ImagePickupDevices value(String value) {
        this.setValue(value);
        return this;
    }
    ...
    public ImagePickupDevices schematicPart(String schematicPart) {
    ...
    public ImagePickupDevices ratingVoltage(String ratingVoltage) {
    ...
    public ImagePickupDevices ratingElectricity(String ratingElectricity) {
    ...
    public ImagePickupDevices characteristics(String characteristics) {
    ...
    public ImagePickupDevices tolerance(String tolerance) {
    ...
    public ImagePickupDevices manufacture(String manufacture) {
    ...
    public ImagePickupDevices bCode(String bCode) {
        this.setbCode(bCode);
        return this;
    }
    ...
    public ImagePickupDevices partsName(String partsName) {
    ...
    public ImagePickupDevices itemRegistrationClassification(String itemRegistrationClassification) {
    ...
    public ImagePickupDevices spiceModel(String spiceModel) {
    ...
    public ImagePickupDevices pcbFootPrint(String pcbFootPrint) {
    ...
    public ImagePickupDevices delFlag(Boolean delFlag) {
    ...
    public ImagePickupDevices remark(String remark) {
    ...
    public ImagePickupDevices createBy(String createBy) {
    ...
    public ImagePickupDevices createTime(Instant createTime) {
    ...
    public ImagePickupDevices updateBy(String updateBy) {
    ...
    public ImagePickupDevices updateTime(Instant updateTime) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ImagePickupDevices)) {
            return false;
        }
        return getId() != null && getId().equals(((ImagePickupDevices) o).getId());
    }
