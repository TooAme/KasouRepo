...
public class Inductors implements Serializable {
    ...
    // 删除原有的 uuid 相关方法
    // public UUID getUuid() { ... }
    // public Inductors uuid(UUID uuid) { ... }
    // public void setUuid(UUID uuid) { ... }
    public String getPartNumber() {
        return this.partNumber;
    }

    public Inductors partNumber(String partNumber) {
    ...
    public Inductors partType(String partType) {
    ...
    public Inductors value(String value) {
        this.setValue(value);
        return this;
    }
    ...
    public Inductors schematicPart(String schematicPart) {
    ...
    public Inductors ratingVoltage(String ratingVoltage) {
    ...
    public Inductors ratingElectricity(String ratingElectricity) {
    ...
    public Inductors characteristics(String characteristics) {
    ...
    public Inductors tolerance(String tolerance) {
    ...
    public Inductors manufacture(String manufacture) {
    ...
    public Inductors bCode(String bCode) {
        this.setbCode(bCode);
        return this;
    }
    ...
    public Inductors partsName(String partsName) {
    ...
    public Inductors itemRegistrationClassification(String itemRegistrationClassification) {
    ...
    public Inductors spiceModel(String spiceModel) {
    ...
    public Inductors pcbFootPrint(String pcbFootPrint) {
    ...
    public Inductors delFlag(Boolean delFlag) {
    ...
    public Inductors remark(String remark) {
    ...
    public Inductors createBy(String createBy) {
    ...
    public Inductors createTime(Instant createTime) {
    ...
    public Inductors updateBy(String updateBy) {
    ...
    public Inductors updateTime(Instant updateTime) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Inductors)) {
            return false;
        }
        return getId() != null && getId().equals(((Inductors) o).getId());
    }
