...
public class Switches implements Serializable {
    ...
    // 删除原有的 uuid 相关方法
    // public UUID getUuid() { ... }
    // public Switches uuid(UUID uuid) { ... }
    // public void setUuid(UUID uuid) { ... }
    public String getPartNumber() {
        return this.partNumber;
    }

    public Switches partNumber(String partNumber) {
    ...
    public Switches partType(String partType) {
    ...
    public Switches value(String value) {
        this.setValue(value);
        return this;
    }
    ...
    public Switches schematicPart(String schematicPart) {
    ...
    public Switches ratingVoltage(String ratingVoltage) {
    ...
    public Switches ratingElectricity(String ratingElectricity) {
    ...
    public Switches characteristics(String characteristics) {
    ...
    public Switches tolerance(String tolerance) {
    ...
    public Switches manufacture(String manufacture) {
    ...
    public Switches bCode(String bCode) {
        this.setbCode(bCode);
        return this;
    }
    ...
    public Switches partsName(String partsName) {
    ...
    public Switches itemRegistrationClassification(String itemRegistrationClassification) {
    ...
    public Switches spiceModel(String spiceModel) {
    ...
    public Switches pcbFootPrint(String pcbFootPrint) {
    ...
    public Switches delFlag(Boolean delFlag) {
    ...
    public Switches remark(String remark) {
    ...
    public Switches createBy(String createBy) {
    ...
    public Switches createTime(Instant createTime) {
    ...
    public Switches updateBy(String updateBy) {
    ...
    public Switches updateTime(Instant updateTime) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Switches)) {
            return false;
        }
        return getId() != null && getId().equals(((Switches) o).getId());
    }
